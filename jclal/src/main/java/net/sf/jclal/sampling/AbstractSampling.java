...
public abstract class AbstractSampling implements ISampling, IConfigure {
    ...
    /**
     *
     * @param initialLabeledData The labeled data.
     */
    ...
    /**
     *
     * @param unlabeledData The unlabeled data.
     */
    ...
    public void configure(Configuration configuration) {
        ...
        double percentageInstancesToLabelledTemp = configuration.getDouble(
                "percentage-to-select", 10);
        String perc = "\n<percentage-to-select>" + percentageInstancesToLabelledTemp
    ...
    /**
     *
     * @param percentageInstancesToLabelled The percentage of instances to
     * labeled.
     */
    public void setPercentageInstancesToLabelled(
            double percentageInstancesToLabelled) {
