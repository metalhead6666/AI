...
public class Resample extends AbstractSampling {
     ...
     * Whether to perform sampling with replacement or without
     * 
     * @param noReplacement the replacement is used or not.
     * 
     */
     ...
     * replacement)
     * 
     * @param invertSelection Set the invert selection.
     *
     */
     ...
     */
    public void createSubsampleWithReplacement(IDataset dataSet,
            int sampleSize) {
        ...
        if (dataSet instanceof MulanDataset) {
            setLabeledData(new MulanDataset(labeledInstances,
        ...
        if (dataSet instanceof MulanDataset) {
            setUnlabeledData(new MulanDataset(unlabeledInstances,
                    ((MulanDataset) dataSet).getLabelsMetaData()));
        }
