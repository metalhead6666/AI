...
public class UtilsSwing {
    ...
    /**
     * It establishes the size in accordance with his components, it centers the
     * content and establishes like option of shutdown that hides.
     *
     * @param x The JFrame.
     */
     ...
     * @return True if the element exist in the comboxbox, false otherwise
     */
    ...
    /**
     * Verifies if the bent one contains to the element and if is not then add
