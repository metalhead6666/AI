 ...
 */
public class XMLConfigurationBuilder extends AbstractXMLConfiguration
        implements IXMLConfigurationBuilder {
     ...
     */
    public XMLConfigurationBuilder(String filePath, boolean replace)
            throws Exception {
     ...
     */
    public XMLConfigurationBuilder(File file, boolean replace)
            throws Exception {
    ...
    public void defineListenerReportFrequency(int newListenerReportFrequency,
            int numOfListener) {
        experiment.setProperty(textListenerReportFrequency(numOfListener),
                newListenerReportFrequency);
    }

    public void defineListenerReportOnFile(boolean newListenerReportOnFile,
            int numOfListener) {
        experiment.setProperty(textListenerReportOnFile(numOfListener), newListenerReportOnFile);
    }

    public void defineListenerReportOnConsole(boolean newListenerReportOnConsole,
            int numOfListener) {
        experiment.setProperty(textListenerReportOnConsole(numOfListener),
                newListenerReportOnConsole);
    }
    ...
    public void defineListenerShowPassiveLearning(boolean newListenerShowPassiveLearning,
            int numOfListener) {
        experiment.setProperty(textListenerShowPassiveLearning(numOfListener),
                newListenerShowPassiveLearning);
    }
    //************
    ...
    public void defineListenerSendMailSmtpHost(String newListenerSendMailSmtpHost,
            int numOfListener) {
        experiment.setProperty(textListenerSendMailSmtpHost(numOfListener),
                newListenerSendMailSmtpHost);
    }

    public void defineListenerSendMailSmtpPort(int newListenerSendMailSmtpPort,
            int numOfListener) {
        experiment.setProperty(textListenerSendMailSmtpPort(numOfListener),
                newListenerSendMailSmtpPort);
    }

    public void defineListenerSendMailTo(String newListenerSendMailTo,
            int numOfParentListener, int numOfRecipient) {
        experiment.setProperty(textListenerSendMailTo(numOfParentListener, numOfRecipient),
                newListenerSendMailTo);
    }

    public void defineListenerSendMailFrom(String newListenerSendMailFrom, int numOfListener) {
        experiment.setProperty(textListenerSendMailFrom(numOfListener),
                newListenerSendMailFrom);
    }

    public void defineListenerSendMailAttachReportFile(boolean newListenerSendMailAttachReportFile,
            int numOfListener) {
    ...
    public void defineListenerSendMailUser(String newListenerSendMailUser, int numOfListener) {
        experiment.setProperty(textListenerSendMailUser(numOfListener),
                newListenerSendMailUser);
    }

    public void defineListenerSendMailPassword(String newListenerSendMailPassword, int numOfListener) {
        experiment.setProperty(textListenerSendMailPassword(numOfListener),
                newListenerSendMailPassword);
    }
    //***********
    ...
    public void defineStopCriterionDisjunctionForm(boolean newStopCriterionDisjunctionForm,
            int numOfStopCriterion) {
        experiment.setProperty(textStopCriterionDisjunctionForm(numOfStopCriterion),
                newStopCriterionDisjunctionForm);
    }

    public void defineStopCriterionMeasureName(String newStopCriterionMeasureName,
            int numOfParentStopCriterion, int numOfStopCriterionMeasure) {
        experiment.setProperty(textStopCriterionMeasureName(numOfParentStopCriterion,
                numOfStopCriterionMeasure),
                newStopCriterionMeasureName);
    }

    public void defineStopCriterionMeasureMaximal(boolean newStopCriterionMeasureMaximal,
            int numOfParentStopCriterion, int numOfStopCriterionMeasure) {
        experiment.setProperty(textStopCriterionMeasureMaximal(numOfParentStopCriterion,
                numOfStopCriterionMeasure),
    ...
    public void defineSubQueryClassifierType(String newSubQueryClassifierType,
            int numOfSubQueryClassifier) {
        experiment.setProperty(textSubQueryClassifierType(numOfSubQueryClassifier),
                newSubQueryClassifierType);
    }
    //****************
    ...
    public void defineQueryStrategyMaxEpsilonIteration(int newQueryMaxEpsilonIteration) {
        experiment.setProperty(textQueryStrategyMaxEpsilonIteration(), 
                newQueryMaxEpsilonIteration);
    }
    ...
    public void defineSubQueryStrategyMaxEpsilonIteration(int newSubQueryMaxEpsilonIteration) {
        experiment.setProperty(textSubQueryStrategyMaxEpsilonIteration(), 
                newSubQueryMaxEpsilonIteration);
    }
     ...
     *
     *@param newMultiLabel Flag that indicates if the dataset is multi-label
     *
     */
     ...
     * Used in multi-label experiments.
     * 
     * @param newFileXml The file name
     *
     */
     ...
     * Used in multi-label experiments.
     * 
     * @param newBaseClassifierType The base classifier to use
     * @param numOfParentClassifier The number of classifier to use
     * @param numOfBaseClassifier The number of base classifier to use
     *
     */
    public void defineBaseClassifierType(String newBaseClassifierType,
            int numOfParentClassifier, int numOfBaseClassifier) {
     ...
     * Used in multi-label experiments.
     * 
     * @param newSubQueryBaseClassifierType The base classifier to use
     * @param numOfParentClassifier The number of classifier to use
     * @param numOfBaseClassifier The number of base classifier to use
     *
     */
    public void defineSubQueryBaseClassifierType(String newSubQueryBaseClassifierType,
            int numOfParentClassifier, int numOfBaseClassifier) {
     ...
     * Used in multi-label experiments.
     * 
     * @param newQueryStrategyEvidenceDimension The evidence dimension to use
     *
     */
     ...
     * Used in multi-label experiments.
     * 
     * @param newQueryStrategyClassDimension The class dimension to use
     *
     */
     ...
     * Used in multi-label experiments.
     * 
     * @param newQueryStrategyWeightDimension The Weight dimension to use
     *
     */
