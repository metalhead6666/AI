...
public class SenderEmail implements IConfigure {
     ...
     * If includes a report file
     * 
     * @param attachReporFile Flag that indicates whether a file is attached or not.
     */
    ...
    public void sendEmail(String subject, String content, File reportFile) {
        ...
        try {
            ...
            Logger.getLogger(SenderEmail.class.getName()).log(
                    Level.SEVERE, null, e);
        }
    ...
    public void configure(Configuration configuration) {
        ...
        int portT = configuration.getInt("smtp-port",
                21);
