...
public class TimeControl implements Serializable {
    ...
    /**
     * Returns the time that exists between two marks
     *
    ...
    /**
     * Returns the time that exists between two marks discounting time
     *
     * @param mark1 The first mark
     * @param mark2 The second mark
    ...
    /**
     * Returns the time that exists between the first mark and the last one
     *
     * @return The difference
     */
    public long time() {
    ...
    /**
     * Returns the time that exists between the last two marks
     *
     * @return The difference
     */
    ...
    /**
     * Adds a name associated to the time
     *
     * @param name The name
    ...
    /**
     * Returns the names and the times
     *
