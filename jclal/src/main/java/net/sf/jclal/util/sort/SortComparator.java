...
public class SortComparator implements Comparator<Container> {
    ...
    /**
     * Flags to determine if the array must be ordered in descendent or ascendent order.
     */
    private boolean maxMin = false;

    /**
     *
     * @param maxMin It determines how the selection should be ordered.
     *
    ...
    /**
     *
     * It determines like the selection should be ordered.
     *
     * If maxMin = false The selection was ordered of smaller to bigger.
     *
     */
