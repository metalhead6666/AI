...
public class Matrix {
     ...
     * @param overFile Indicates if the matrix will be stored over a file
     * @throws java.lang.Exception The exception that will be launched.
     */
    public Matrix(int m, int n, boolean overFile)
            throws Exception {
     ...
     *
     * @throws FileNotFoundException The type of exception to launch.
     */
    private void openFileMatrix() throws FileNotFoundException {
        ...
        if (fileAccessN == null) {
            ...
            try {
                ...
                fileAccessN = Files.newByteChannel(p,
     ...
     * Close the file
     *
     * @throws IOException The type of exception to launch.
     */
     ...
     * The file of a matrix
     *
     * @param matrixFile The file where the data will be stored.
     */
     ...
     * Path file path
     *
     * @param matrixFilePath The path of the matrix file
     */
     ...
     * @return A(i,j)
     * @throws ArrayIndexOutOfBoundsException The type of exception to launch.
     */
     ...
     * @param i The row
     * @param j The column
     * @param s The value to write in the matrix file
     * @throws IOException The exception to launch
     */
     ...
     * @param m Number of rows.
     * @param n Number of colums.
     * @param overFile Indicates if the matrix is stored over the a file or over
     * the main memory
     ...
     * by default the the matrix is stored over the main memory
     *
     * @param overFile Set whether the data will be stored over a file or main
     * memory.
     */
