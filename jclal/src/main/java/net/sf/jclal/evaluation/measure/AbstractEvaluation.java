...
/**
 * Abstract class for the evaluation measures.
 *
...
public class AbstractEvaluation implements IEvaluation {
    ...
    /**
     * Represents the labeled set size.
     */
    ...
    /**
     * Represents the unlabeled set size.
     */
    ...
    /**
     *
     * @return the evaluation measures ordered alphabetically
     */
    @Override
    ...
    /**
     * Get the value of a metric by its name
     * @param metricName The metric name
     * @return the value of a metrics as the name.
     */
    @Override
     ...
     *
     * @param metricName the value of a metrics as the name
     */
    @Override
    ...
    /**
     *
     * @param labeledSetSize The size of the set of labeled instances.
     */
    ...
    /**
     *
     * @param unlabeledSetSize The size of the set of unlabeled instances.
     */
    ...
    /**
     * To extract from a text the evaluation measurements. In the first line the
     ...
     *
     * @param stringEvaluation The evaluation in string format 
     */
    @Override
    ...
    /**
     * Return in a string the complete evaluation.
     *
     * @return String with the complete evaluation.
     */
    @Override
