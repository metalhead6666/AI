...
/**
 * Example of hold out experiment that uses the entropy sampling as query strategy,
 * pool-base as scenario and the classical AL process.
 *
...
public class HoldOutExample {
    ...
    public static void main(String[] args) {
        ...
        String fileName = "datasets/mfeat-pixel (10 clases).arff";
