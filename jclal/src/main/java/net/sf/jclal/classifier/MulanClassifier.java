...
public class MulanClassifier extends AbstractClassifier {
    ...
    /**
     *
     * @param classifier The multilabel classifier to use
     */
    ...
    public double[] distributionForInstance(Instance instance) {
        ...
        try {
            ...
            Logger.getLogger(MulanClassifier.class.getName()).log(
                    Level.SEVERE, null, e);
        }
        return null;
    }
    ...
    /**
     *
     * @param instances The set of instances to test
     * @return an evaluation of the model.
     */
    @Override
    public AbstractEvaluation testModel(IDataset instances) {
        ...
        try {
            ...
            MulanEvaluation eval=new MulanEvaluation(evaluator.evaluate(classifier,
                    ((MulanDataset) instances).getMultiLabelDataset()), ((MulanDataset) instances).getMultiLabelDataset());
    ...
    public String toString() {
        ...
        if (classifier instanceof TransformationBasedMultiLabelLearner) {
            st += "(" + ((TransformationBasedMultiLabelLearner) classifier).getBaseClassifier().getClass().getSimpleName() + ")";
        }
        ...
        try {
            ...
            if (TransformationBasedMultiLabelLearner.class.isAssignableFrom(classifierClass)) {
                ...
                try {
                    ...
                    // classifier classname
                    String baseClassifier = conf
                            .getString("base-classifier[@type]");
                    ...
                    // classifier instance
                    Classifier baseClassifierInstance = baseClassifierClass
                            .newInstance();

                    multiLabelClassifier = classifierClass.getConstructor(new Class<?>[]{Classifier.class}).newInstance(baseClassifierInstance);
