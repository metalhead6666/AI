...
public class PoolBasedSamplingScenario extends AbstractScenario {
    ...
    /**
     * Selects the most informative instances of the <b>pool</b> according to
     * the scenario, the query strategy and the batch mode. Stores the selected
    ...
    public void instancesSelection() {
        ...
        ((AbstractQueryStrategy) getQueryStrategy()).getSelectedInstances().addAll(getBatchMode().instancesSelection(getQueryStrategy(), seleccion));
    }
