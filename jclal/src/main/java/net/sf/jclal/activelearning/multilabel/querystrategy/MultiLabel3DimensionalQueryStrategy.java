 ...
 *
 * See for more information Esuli, A., and Sebastiani, F. (2009). Active Learning
 * Strategies for Multi-Label Text Classification, 102-113.
 *
 * @author Oscar Gabriel Reyes Pupo
 *
 */
public class MultiLabel3DimensionalQueryStrategy extends
        AbstractMultiLabelQueryStrategy implements IConfigure {
     ...
     * 
     * W (Weighting): One choice is to give more weight to those classes on which
     * the current classifier is still performing badly, so as to prefer those
     * documents that are likely to bring about an improvement where it is most
     * needed.
     */
        ...
        try {
            ...
            switch (classDimension) {
                ...
                case 'R':
                    ...
                    System.err
                            .println("The Round Robin (R) option is not supported yet");
                    System.exit(1);
            ...
            Logger.getLogger(MultiLabel3DimensionalQueryStrategy.class.getName()).log(
                    Level.SEVERE, null, e);
    ...
    /**
     *
     * @param evidenceDimension The evidence dimension to use
     */
    ...
    /**
     *
     * @param classDimension The class dimension to use
     */
    ...
    /**
     *
     * @param weightDimension The class dimension to use
     */
