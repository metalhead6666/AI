 ...
 *
 * It reduces generalization error indirectly by minimizing output variance.
 *
...
public class VarianceReductionQueryStrategy extends AbstractSingleLabelQueryStrategy {
     ...
     *
     * @param q The q value.
     * @param copiaQ The copy of q.
     * @param epsilon The epsilon value.
     * @return Return whether there was some significant change in accordance with
     * epsilon.
     */
     ...
     *
     * @param unlabeled The unlabeled set
     ...
     * 
     * @param current The matrix.
     * @param vectorX The vector.
     */
    ...
    /**
     *
     * @param factorRegularization The factor of regularization. Used in
     * Variance Reduction.
     */
    ...
    /**
     *
     * @param epsilon Epsilon. Used in Variance Reduction.
     */
    ...
    public double getEpsilon() {
        if (epsilon == -1) {
            epsilon = 1.0 / ((getUnlabelledData().getNumInstances()
                    + getLabelledData().getNumInstances()) * 100);
        }
        return epsilon;
    }
     ...
     * 
     * @param maxEpsilonIteration The maximum number of iterations.
     *
     */
    ...
    public void configure(Configuration configuration) {
        ...
        double currentFactorRegularization = configuration.
                getDouble("factor-regularization", factorRegularization);
