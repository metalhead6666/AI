...
/**
 * Implementation of StreamBasedSelectiveSampling scenario. This scenario is
 * sometimes called stream-based or sequential active.
 *
...
public class StreamBasedSelectiveSamplingScenario extends AbstractScenario {
    ...
    /*
     * The threshold must be configured in dependence of the query strategy. For example:
     * 
     * UncertaintySampling=0.5
     * DensityDiversity=0.7
     * EntropySamplingQueryStrategy=0.7
     * LeastConfidence=0.7
     * ErrorReduction=0.39
     * MarginSampling=0.7
     * RandomSampling=1
     * RelevanceSampling=0.7
     * 
     */
    ...
    /**
     * @param threshold The threshold used when the scenario is stream.
     *
     */
    ...
    /**
     * Selects the most informative instances sequentially according to the
    ...
    public void instancesSelection() {
        ...
        ((AbstractQueryStrategy) getQueryStrategy()).getSelectedInstances().addAll(getBatchMode().instancesSelection(getQueryStrategy(), selection));
    }
