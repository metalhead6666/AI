...
/**
 * Abstract class for single label query strategies.
 *
 */
public abstract class AbstractSingleLabelQueryStrategy extends
        AbstractQueryStrategy {

    private static final long serialVersionUID = 1L;

    /**
     * It is used after to complete the algorithm
     */
    @Override
