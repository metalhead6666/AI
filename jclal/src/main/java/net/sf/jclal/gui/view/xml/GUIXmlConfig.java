...
/**
 * Utility class to load the properties needed to construct experiments. Can be
 * used few files to config the experiment or all the elements can by in one
 * file but the diferents elements types must be separated by at least <b>one
 * empty line</b>.
 *
...
public class GUIXmlConfig {
    ...
    /**
     * Utitlitarian class to manipulate combo elements.
     */
